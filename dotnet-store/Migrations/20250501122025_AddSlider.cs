    ...
    public partial class AddSlider : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Slider 1 Aciklama", true, "Slider 1 Baslik", 0, "slider-1.jpeg" },
                    { 2, "Slider 2 Aciklama", true, "Slider 2 Baslik", 1, "slider-2.jpeg" },
                    { 3, "Slider 3 Aciklama", true, "Slider 3 Baslik", 2, "slider-3.jpeg" }
                });
        }
